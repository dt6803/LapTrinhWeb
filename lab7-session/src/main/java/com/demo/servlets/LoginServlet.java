...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet_Welcome(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void doPost_Login(HttpServletRequest request, HttpServletResponse response)
		...
		if (accountModel.checkLogin(email, password)) {
			...
			request.getSession().setAttribute("msg", "Email hoặc mật khẩu không đúng");
